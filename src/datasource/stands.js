export const stands = [
    ...
    },
    {
        ...
        boissons: [
            { nom: "Coca", prix: 3.5, image: require('@/assets/images/coca.png') },
    ...
    },
    {
        ...
        boissons: [
            { nom: "Oasis", prix: 3.5, image: require('@/assets/images/oasis.png') },
            { nom: "Coca", prix: 3.5, image: require('@/assets/images/coca.png') },
            { nom: "Coca zéro", prix: 4, image: require('@/assets/images/coca_zero.png') },
            { nom: "Fuzetea", prix: 2.5, image: require('@/assets/images/fuzetea.png') },
        ],
        notes: [],
        commentaires: [],
    },
    {
        ...
        nourritures: [
            ...
            { nom: "Gaufre confiture", prix: 8.5, image: require('@/assets/images/gaufre_confiture.png') },
    ...
    },
    {
        ...
        nourritures: [
            ...
            { nom: "Glace (parfum au choix)", prix: 4.5, image: require('@/assets/images/glaces.png') },
        ...
        boissons: [
            ...
            { nom: "Coca", prix: 3.5, image: require('@/assets/images/coca.png') },
            { nom: "Coca zéro", prix: 4, image: require('@/assets/images/coca_zero.png') },
            { nom: "Orangina", prix: 3.5, image: require('@/assets/images/orangina.png') },
            { nom: "Fanta", prix: 4, image: require('@/assets/images/fanta.png') },
        ],
        notes: [],
        commentaires: [],
    },
    {
        ...
        nourritures: [
            ...
            { nom: "Cookies", prix: 5.5, image: require('@/assets/images/cookies.png') },
            { nom: "Churros", prix: 5, image: require('@/assets/images/churros.png') },
        ],
        boissons: [
            { nom: "Oasis", prix: 3.5, image: require('@/assets/images/oasis.png') },
