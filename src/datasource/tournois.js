export const tournois = [
    {
        ...
        dates: [
            { mois: 7, jour: 10, heures: 19, min: 0 },
            { mois: 7, jour: 12, heures: 18, min: 30 },
            { mois: 7, jour: 14, heures: 18, min: 0 },
        ],
    ...
    },
    {
        ...
        lieu: "Domaine des loges",
        dates: [
            { mois: 7, jour: 9, heures: 19, min: 0 },
            { mois: 7, jour: 11, heures: 18, min: 0 },
            { mois: 7, jour: 13, heures: 17, min: 30 },
        ],
    ...
    },
    {
        ...
        dates: [
            { mois: 7, jour: 10, heures: 14, min: 0 },
            { mois: 7, jour: 14, heures: 15, min: 30 },
            { mois: 7, jour: 18, heures: 13, min: 0 },
        ],
    ...
    },
    {
        ...
        dates: [
            { mois: 7, jour: 9, heures: 15, min: 0 },
            { mois: 7, jour: 12, heures: 16, min: 30 },
            { mois: 7, jour: 16, heures: 14, min: 0 },
        ],
    ...
    },
    {
        ...
        dates: [
            { mois: 7, jour: 10, heures: 14, min: 30 },
            { mois: 7, jour: 13, heures: 15, min: 0 },
            { mois: 7, jour: 17, heures: 16, min: 0 },
        ],
    ...
    },
    {
        ...
        dates: [
            { mois: 7, jour: 11, heures: 9, min: 0 },
            { mois: 7, jour: 15, heures: 10, min: 30 },
            { mois: 7, jour: 20, heures: 8, min: 0 },
        ],
    ...
    },
    {
        ...
        lieu: "Place du drapeau",
        dates: [
            { mois: 7, jour: 9, heures: 16, min: 0 },
            { mois: 7, jour: 14, heures: 17, min: 30 },
            { mois: 7, jour: 18, heures: 15, min: 0 },
        ],
