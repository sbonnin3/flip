<template>
  <div class="statistiques-view">
    ...
    <div class="navigation-container">
      ...
      <button @click="goForward" class="nav-button" :disabled="startIndex + displayedDays >= totalDays">
        Suivant ➡
      </button>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      startIndex: 0,
      displayedDays: 3,
      totalDays: statistiques.dailyViews.length,
      daysOptions: [3, 4, 5, 6, 7, 8, 9, 10],
    };
  },
  methods: {
    goBack() {
